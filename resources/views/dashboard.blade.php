                ...
                <script type="text/javascript">
                    ...
                    google.charts.setOnLoadCallback(drawChart);
                       function drawChart() {
                         ...
                         var options = {
                         title: 'Pie chart for registed users',
                         is3D: true,
                        };
      ...
      <div class="card h-100 p-3">
        <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
          ...
          <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
            <h5 class="text-white font-weight-bolder mb-4 pt-2">ST.JAMES TAS</h5>
            <p class="text-white">You are welcome to TeacherCess. TeacherCess is teachers assessment system which involve data analysis to analysis teachers performance within the academic year.</p>
